...
!function(e,t){
  ...
  'use strict';var n=[],r=e.document,i=Object.getPrototypeOf,o=n.slice,a=n.concat,s=n.push,u=n.indexOf,l={},c=l.toString,f=l.hasOwnProperty,p=f.toString,d=p.call(Object),h={},g=function e(t){
    ...
    var e,t,n,r,i,o,a=arguments[0]||{},s=1,u=arguments.length,l=!1;for('boolean'===typeof a&&(l=a,a=arguments[s]||{},s++),'object'===typeof a||g(a)||(a={}),s===u&&(a=this,s--);s<u;s++)if(null!=(e=arguments[s]))for(t in e)n=a[t],a!==(r=e[t])&&(l&&r&&(w.isPlainObject(r)||(i=Array.isArray(r)))?(i?(i=!1,o=n&&Array.isArray(n)?n:[]):o=n&&w.isPlainObject(n)?n:{},a[t]=w.extend(l,o,r)):void 0!==r&&(a[t]=r));return a
  ...
  }).prototype=w.fn,q=w(r);var H=/^(?:parents|prev(?:Until|All))/,O={children: !0,contents: !0,next: !0,prev: !0};w.fn.extend({has: function(e){
  ...
  }var ze=/^(none|table(?!-c[ea]).+)/,Xe=/^--/,Ue={position: 'absolute',visibility: 'hidden',display: 'block'},Ve={letterSpacing: '0',fontWeight: '400'},Ge=['Webkit','Moz','ms'],Ye=r.createElement('div').style;function Qe(e){
  ...
  },_default: 'swing'},w.fx=tt.prototype.init,w.fx.step={};var nt,rt,it=/^(?:toggle|show|hide)$/,ot=/queueHooks$/;function at(){
    ...
    var n,r=0,i={height: e};for(t=t?1:0;r<4;r+=2-t)i['margin'+(n=oe[r])]=i['padding'+n]=e;return t&&(i.opacity=i.width=e),i
  }function lt(e,t,n){
  ...
  });var gt=/^(?:input|select|textarea|button)$/i,yt=/^(?:a|area)$/i;w.fn.extend({prop: function(e,t){
    ...
    var t,n,r,i=this[0];{if(arguments.length)return r=g(e),this.each(function(n){
  ...
  };var Vt={0: 200,1223: 204},Gt=w.ajaxSettings.xhr();h.cors=!!Gt&&'withCredentials'in Gt,h.ajax=Gt=!!Gt,w.ajaxTransport(function(t){
  ...
  });var Yt=[],Qt=/(=)\?(?=&|$)|\?\?/;w.ajaxSetup({jsonp: 'callback',jsonpCallback: function(){
    ...
    var r,i,o,a=this,s=e.indexOf(' ');return s>-1&&(r=vt(e.slice(s)),e=e.slice(0,s)),g(t)?(n=t,t=void 0):t&&'object'===typeof t&&(i='POST'),a.length>0&&w.ajax({url: e,type: i||'GET',dataType: 'html',data: t}).done(function(e){
    ...
    if(this[0]){
      var e,t,n,r=this[0],i={top: 0,left: 0};if('fixed'===w.css(r,'position'))t=r.getBoundingClientRect();else{
